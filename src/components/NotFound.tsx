...
export default function NotFound() {
  ...
  return (
    <>
      <h1 className='text-4xl font-semibold mt-4'>Lo sentimos la página no ha sido encontrada</h1>
      ...
      <div className='w-1/2 content-center justify-center rounded-lg bg-red-600 p-8 text-white shadow-lg dark:bg-red-500'>
        <p>
          ...
          URL o regresa a la pagina principal.Para regresar a la pagina principal
